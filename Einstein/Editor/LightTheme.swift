...
public struct LightTheme: SourceCodeTheme {
    public var lineNumbersStyle: LineNumbersStyle? = LineNumbersStyle(font: Constants.codeFont, textColor: Color.darkGray)
    ...
    public func globalAttributes() -> [NSAttributedString.Key: Any] {
        return [.font: Constants.codeFont, .foregroundColor: Color.black]
    }
